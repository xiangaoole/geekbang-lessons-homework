...
import static org.geektimes.rest.util.URLUtils.AND;
import static org.geektimes.rest.util.URLUtils.EQUAL;
...
public class HttpPostInvocation implements Invocation {
    ...
    /**
     * Write request's entity to urlConnection's output stream
     *
     * @param urlConnection
     */
